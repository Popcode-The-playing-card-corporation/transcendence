...
class Room(models.Model):
    ...
    host = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='hosted_rooms')
...
class GameLog(models.Model):
    ...
    player = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='player')
