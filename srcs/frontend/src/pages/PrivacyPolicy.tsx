export function PrivacyPolicy() {
  return (
    <div className="page-content mt-17 min-h-screen">
      <div>
        <div>
          <strong>
        ...
        <div className="text-center">
          <span className="text-sm text-center font-bold">
            Last updated
            <span className="ml-2">June 01, 2026</span>
          </span>
        </div>
        <div>
          <span>
        ...
        <a
          ...
          href="mailto:popcorn.coders@gmail.com"
        >
        ...
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">
            ...
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <span className="question noTranslate">
                <a
                  target="_blank"
                  data-custom-class="link"
                  href="mailto:popcorn.coders@gmail.com"
                                              ...
                                              <ul>
                                                ...
                                                >
                                                  ...
                                                  >
                                                    ...
                                                    statistics projects, subject
                                                    to ethics oversight and
                                                                  ...
                                                                  <span data-custom-class="body_text">
                                                                    <span className="question noTranslate">
                                                                      <a
                                                                        target="_blank"
                                                                        data-custom-class="link"
                                                                        href="http://www.popcards.com/cookies"
                                                                      >
                                                                        http://www.popcards.com/cookies
                                                                      </a>
                                                                    </span>
                                                                  </span>
                                                                </span>
                                                                              ...
                                                                              >
                                                                                ...
                                                                                >
                                                                                  <a
                                                                                    ...
                                                                                    href="https://app.termly.io/dsar/164d545a-caf3-4444-b23a-268a4f5344ab"
                                                                                  />
                                                                                </div>
                                                                              </div>
                                                                              <style
