export function TermsOfService() {
  return (
    <div className="page-content mt-17 ">
      ...
      <br />
      <strong>Last updated June 01, 2026</strong>
      <br /><br /><br /><br />
      ...
      <ol className="list-decimal ms-8">
        <a className="link-hover"><li>OUR SERVICES</li></a>
        <a className="link-hover"><li>INTELLECTUAL PROPERTY RIGHTS</li></a>
        <a className="link-hover"><li>USER REPRESENTATIONS</li></a>
        <a className="link-hover"><li>USER REGISTRATION</li></a>
        <a className="link-hover"><li>PROHIBITED ACTIVITIES</li></a>
        <a className="link-hover"><li>USER GENERATED CONTRIBUTIONS</li></a>
        <a className="link-hover"><li>CONTRIBUTION LICENCE</li></a>
        <a className="link-hover"><li>SOCIAL MEDIA</li></a>
        <a className="link-hover"><li>THIRD-PARTY WEBSITES AND CONTENT</li></a>
        <a className="link-hover"><li>SERVICES MANAGEMENT</li></a>
        <a className="link-hover"><li>PRIVACY POLICY</li></a>
        <a className="link-hover"><li>COPYRIGHT INFRINGEMENTS</li></a>
      ...
      <p>
        ...
        <a className="link" href="https://termly.io/products/terms-and-conditions-generator/"> Terms and Conditions Generator</a>
